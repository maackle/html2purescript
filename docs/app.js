...
(function(exports) {
  ...
  var run = function (body) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("run"))(function () {
          return Halogen_VDom_Driver.runUI(Component.component)(Data_Unit.unit)(body);
      });
  };
  var rerunUI = function (body) {
      return Control_Monad_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("rerunUI"))(function () {
          return run(body);
      }));
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("main"))(function () {
          return run(v);
      });
  }));
  exports["main"] = main;
